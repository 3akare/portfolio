        ...
        <section
            ...
            <div className={"grid grid-cols-1 md:grid-cols-2 gap-x-6"}>
                ...
                <div className={"flex flex-col gap-12 text-lg md:text-xl"}>
                    <h3 className={"text-2xl md:text-3xl"}>I am a dedicated product designer with a passion for creating
                        fun and intuitive designs. Over the last 7 years I’ve worked on many projects in many
                        industries. From mobile applications to web products. I translate ideas into effective and
                        highly-crafted solutions.</h3>
                    <p className={"text-lg md:text-xl text-[#333333] dark:text-[#cccccc]"}>My approach to design is
                        grounded in research and collaboration. I believe that the best results come from understanding
