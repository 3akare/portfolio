...
export default function Header() {
    return (
        <header className={"w-full flex justify-center"}>
            <nav
                className={"fixed bg-white dark:bg-black top-0 w-full h-[4.75rem] z-20 container mx-auto max-w-[90rem] flex flex-row justify-between items-center px-[40px] md:px-[64px] lg:px-[80px]"}>
