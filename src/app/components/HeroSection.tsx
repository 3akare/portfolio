export default function HeroSection() {
    return (
        <section
            className={"container relative top-[4.75rem] mx-auto max-w-[90rem] w-full flex flex-wrap text-wrap flex-row justify-between items-center py-[3.75rem] px-[2.5rem] md:py-[5rem] lg:py-[7.5rem] md:px-[4rem]"}>
