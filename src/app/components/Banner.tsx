    ...
    return (
        <section id={"contact"}>
            ...
            <section
                ...
                <div
                    ...
                    <Link
                        ...
                        className="text-2xl lg:text-3xl text-center font-semibold hover:opacity-65 transition-[opacity] duration-300"
                    >
            ...
            <section className="py-[60px] block md:hidden">
                <div
                    className="flex flex-col items-center justify-center gap-12 px-[40px] py-[60px] bg-[linear-gradient(125deg,#fff5e6,#ffe6eb)] dark:bg-[linear-gradient(125deg,#2c0838,#901d4d,#ff6f66)] text-center">
                    <h2 className="max-w-[700px] text-4xl font-semibold">
                        Want to create something <br/> awesome? Drop me an email.
                    </h2>
                    <Link
                        href="mailto:bakaredavid007@gmail.com"
                        className="text-lg sm:text-xl mf:text-2xl text-center font-semibold hover:opacity-65 transition-[opacity] duration-300"
                    >
                        → bakaredavid007@gmail.com
                    </Link>
                </div>
