    ...
    return (
        <section id={"contact"}>
            ...
            <section className="container mx-auto max-w-[90rem] py-[60px] px-[40px] md:px-[64px] lg:px-[80px] md:block hidden">
                <div className="flex flex-col items-center justify-center gap-12 px-[80px] py-[128px] bg-[linear-gradient(125deg,#fff5e6,#ffe6eb)] dark:bg-[linear-gradient(125deg,#2c0838,#901d4d,#ff6f66)] rounded-2xl">
            ...
            <section className="py-[60px] block md:hidden">
                <div className="flex flex-col items-center justify-center gap-12 px-[40px] py-[60px] bg-[linear-gradient(125deg,#fff5e6,#ffe6eb)] dark:bg-[linear-gradient(125deg,#2c0838,#901d4d,#ff6f66)]  text-center bg-[linear-gradient(121deg,#000000,15%,#901d4d,50%,#ff6f66)]">
