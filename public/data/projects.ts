...
import microservice from "../microservices.webp"
import compiler from "../compiler.gif"
import monty from "../monty.webp"
import paycraft from "../paycraft.webp"
...
export const projects = [
    ...
    },
    {
        ...
        data: {
            ...
            liveUrl: "Not Available",
            sourceUrl: "https://github.com/PayCraft-NG",
            paragraphs: [
    ...
    },
    {
        ...
        data: {
            ...
            paragraphs: [
                "This application translates Tiny BASIC code into JavaScript, a dynamically typed language. The compiler consists of three key components: the Lexer, Parser, and Emitter. The Lexer breaks the input code into tokens, ensuring it is syntactically valid. The Parser uses these tokens to build an Abstract Syntax Tree (AST), representing the structural correctness of the code. Finally, the Emitter generates equivalent JavaScript code based on the AST."
            ],
            additional: [
